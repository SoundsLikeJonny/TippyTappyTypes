...
class Ui_TypingOverlay(object):
    ...
    def retranslateUi(self, TypingOverlay):
        TypingOverlay.setWindowTitle(QCoreApplication.translate("TypingOverlay", u"TippyTappyTypes Overlay", None))
#if QT_CONFIG(tooltip)
        self.label_update.setToolTip(QCoreApplication.translate("TypingOverlay", u"A new version of TippyTappyTypes is available!", None))
